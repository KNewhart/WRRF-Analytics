Dim NumTrainDays as 3

Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_DO_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_DO_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIX33384_AB3_Z8_DO.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_DO_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_FLOW_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_FLOW_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_FLOW_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_16_VALVE_POS_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_7_VALVE_POS_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.BASIN3_8_VALVE_POS_PVENG.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIA33391_AB3_AMMONIA.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33391_AB3_Z3_NITRATE.F_CV", NumTrainDays+.04, Now)
'Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33391A_AB3_Z3_NITRITE.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIR33392_AB3_Z9_NITRATE.F_CV", NumTrainDays+.04, Now)
'Call ExportDataToCSV("ww-historian", "WWSCADA2.NP4232_CA.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NR4242.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NA33055_ABASIN_INFL_AMMONIA.F_CV", NumTrainDays+.04, Now)
Call ExportDataToCSV("ww-historian", "WWSCADA2.NIF31053_PE_TO_ABAS_FLOW.F_CV", NumTrainDays+.04, Now)
